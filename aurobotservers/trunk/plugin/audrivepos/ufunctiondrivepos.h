 ...
 ***************************************************************************/
#ifndef UFUNC_DRIVEPOS_H
#define UFUNC_DRIVEPOS_H
...
*/
class UFunctionDrivePos : public UFuncPlugBase
...
/*  virtual const char * resourceList()
  ...
  { return UResDrivePos::getResClassID(); }*/
  /**
...
//  bool drivePosLocal;
  ...
  * 0=left, 1=top, 2=right -1=none */
  ...
  double dist;
  /**
  Relative pose as default destination */
  UPoseV relPose;
  /**
  Relative pose as default destination */
  UPoseV absPose;
...
private:
  ...
  bool handleDrivePos(UServerInMsg * msg);
};
