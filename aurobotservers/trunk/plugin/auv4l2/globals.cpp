...
/*	global->imageinc_str = g_new(char, 25);
	...
	global->Sound_enable=false; /*Enable Sound by Default (no/chr)*/
	global->Sound_IndexDev=NULL;
	global->Sound_SampRate=0; //SAMPLE_RATE;
	global->Sound_SampRateInd=0;
	global->Sound_numInputDev=0;
	global->Sound_Format= 0x0050; // WAVE_FORMAT_MPEG12; /*set MP2 by default*/
	global->Sound_DefDev=0; 
	global->Sound_UseDev=0;
	global->Sound_NumChan=0; //NUM_CHANNELS;
