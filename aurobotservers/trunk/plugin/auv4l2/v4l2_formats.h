...
#define MAX_VID_MODES 30

typedef struct _VidCap 
{
	int width;            //width 
	int height;           //height
	int framerate_num[MAX_VID_MODES];   //list of numerator values - should be 1 in almost all cases
	int framerate_denom[MAX_VID_MODES]; //list of denominator values - gives fps
