 ...
 ***************************************************************************/
#ifndef UFUNCMAPOBST_H
#define UFUNCMAPOBST_H
...
*/
class UFuncMapObst : public UFuncPlugBase
...
public:
  ...
  { // command list and version text
    setCommand("mapobst", "mappedObstacles", "convert map items to obstacles");
    mobs = NULL;
  }
  /**
  Destructor */
  virtual ~UFuncMapObst();
  /**
