...
/*         static XMLCALL void _element_start_handler(void *userData,
         ...
         static void _element_start_handler(void *userData,
		  const XML_Char *name, const XML_Char **atts);
	  static void _element_end_handler(void *userData,
		  const XML_Char *name);
	  ...
	  static void _comment_handler(void *userData,
		  const XML_Char *data);
	  static void _default_handler(void *userData,
		  const XML_Char *s, int len);
	...
	public:
	  ...
	  virtual bool Parse(void);
          ...
          /* Delete existing parser and re-create it to parse a new document */
          virtual bool resetParser(); // size_t chunk_size = XML_CHUNK_SIZE);

          /* Register default handlers to external parser-struct */
          void register_default_handlers_external(XML_Parser);
